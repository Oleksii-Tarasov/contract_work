    ...
    <%@include file="/WEB-INF/views/layout/header.jspf" %>
        ...
        <div class="container-sm mt-4 custom-width">
                ...
                <table class="table table-striped-columns">
                    ...
                    <c:forEach var="project2210" items="${projectsForEstimate2210}" varStatus="projectStatus">
                        <tr id="project-${project2210.id}">
                            ...
                            <%-- informatization==true --%>
                                ...
                                <td>
                                    <fmt:formatNumber value="${project2210.generalFund}" pattern="#,##0.00" />
                                </td>
                                <td>
                                    <fmt:formatNumber value="${project2210.specialFund}" pattern="#,##0.00" />
                                </td>
                                <td>
                                    <c:out value="${project2210.justification}" />
                                </td>
                        </tr>
                    </c:forEach>
                    <tr>
                        ...
                        <th>
                            <fmt:formatNumber value="${totalGeneralFund2210}" pattern="#,##0.00" />
                        </th>
                        <th>
                            <fmt:formatNumber value="${totalSpecialFund2210}" pattern="#,##0.00" />
                        </th>
                        <th></th>
                    </tr>
                    <tr class="black-borders">
                    ...
                    <c:forEach var="project2240" items="${projectsForEstimate2240}" varStatus="projectStatus">
                        <tr id="project-${project2240.id}">
                            ...
                            <td>
                                <fmt:formatNumber value="${project2240.generalFund}" pattern="#,##0.00" />
                            </td>
                            <td>
                                <fmt:formatNumber value="${project2240.specialFund}" pattern="#,##0.00" />
                            </td>
                            <td>
                                <c:out value="${project2240.justification}" />
                            </td>
                        </tr>
                    </c:forEach>
                    <tr>
                        ...
                        <th>
                            <fmt:formatNumber value="${totalGeneralFund2240}" pattern="#,##0.00" />
                        </th>
                        <th>
                            <fmt:formatNumber value="${totalSpecialFund2240}" pattern="#,##0.00" />
                        </th>
                        <th></th>
                    </tr>
                    <tr class="black-borders">
                        <th>3110</th>
                        <th colspan="8" style="text-align: left">Придбання обладнання і предметів довгострокового
                            користування
                        </th>
                    </tr>
                    <c:forEach var="project3110" items="${projectsForEstimate3110}" varStatus="projectStatus">
                        <tr id="project-${project3110.id}">
                            ...
                            <td>
                                <fmt:formatNumber value="${project3110.generalFund}" pattern="#,##0.00" />
                            </td>
                            <td>
                                <fmt:formatNumber value="${project3110.specialFund}" pattern="#,##0.00" />
                            </td>
                            <td>
                                <c:out value="${project3110.justification}" />
                            </td>
                        </tr>
                    </c:forEach>
                    <tr>
                        ...
                        <th>
                            <fmt:formatNumber value="${totalGeneralFund3110}" pattern="#,##0.00" />
                        </th>
                        <th>
                            <fmt:formatNumber value="${totalSpecialFund3110}" pattern="#,##0.00" />
                        </th>
                        <th></th>
                    </tr>
                </table>
            ...
            <div class="mt-3 mb-4 d-flex justify-content-between align-items-center">
                ...
                <a href="${pageContext.request.contextPath}/generate-purchases-table"
        ...
        <!-- Modal Action Window (Edit/Delete) -->
        <div class="modal fade" id="actionModal" tabindex="-1" aria-labelledby="actionModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="actionModalLabel">Вибраний проєкт: <strong
                                id="projectNamePlaceholder"></strong></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>

                    <!-- Body 1: Action Selection -->
                    <div class="modal-body" id="actionBody">
                        <p class="mt-3">
                            <a id="editButton" href="#" class="btn btn-primary me-2">Редагувати</a>
                            <!-- Change onclick to call new function confirmDelete() -->
                            <button type="button" class="btn btn-danger" onclick="confirmDelete()">Видалити</button>
                        </p>
                    </div>

                    <!-- Body 2: Delete Confirmation (hidden by default) -->
            ...
            <%@include file="/WEB-INF/views/layout/tableCommonScripts.jspf" %>
                ...
                <%-- Modal Window Functionality --%>
                    <script>
                        ...
                        // Function to switch to confirmation window
                        function confirmDelete() {
                            // Hide first body and show second
                            actionBody.classList.add('d-none');
                            confirmDeleteBody.classList.remove('d-none');

                            // UPDATE TITLE FOR CONFIRMATION
                        ...
                        function cancelDelete() {
                            ...
                            // RESTORE PREVIOUS TITLE ON CANCEL
                            // Use saved project name
