    ...
    <%@include file="/WEB-INF/views/layout/header.jspf" %>
        ...
        <div class="container-sm mt-3">
            <div class="bg-white p-4 rounded shadow">
                ...
                <form method="post" action="${pageContext.request.contextPath}/estimate/new-project">
                    <div class="row">
                        <!-- Лівий стовпчик -->
                        <div class="col-md-6">
                            <!-- КЕКВ -->
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="kekv" name="kekv" required>
                                    ...
                                    <option value="3110">3110 Придбання обладнання і предметів довгострокового
                                        користування</option>
                                </select>
                            </div>
                            <!-- Код ДК: -->
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="dkCode" name="dkCode" maxlength="10"
                                    minlength="10" pattern="\d{8}-\d{1}" required>
                            </div>
